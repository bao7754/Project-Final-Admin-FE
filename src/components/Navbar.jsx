...
const Navbar = () => {
  ...
  // Ẩn Navbar trên trang login (và các trang khác nếu cần)
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="text-xl font-bold text-amber-600">Ẩm Thực Việt</span>
            </Link>
          </div>
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/recipes" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-amber-600 hover:bg-amber-50">
              Công thức
            </Link>
            {isAuthenticated && (
            ...
            {isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="px-4 py-2 rounded-md text-sm font-medium text-white bg-amber-600 hover:bg-amber-700"
              >
                Đăng nhập
              </Link>
            )}
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            {isAuthenticated ? (
              ...
              <div className="px-5">
                <Link
                  to="/login"
                  className="block text-center px-4 py-2 rounded-md text-base font-medium text-white bg-amber-600 hover:bg-amber-700"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Đăng nhập
                </Link>
